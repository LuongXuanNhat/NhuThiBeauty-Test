...
const ServicePopup: React.FC<ServicePopupProps> = ({
  ...
  const currentService =
    serviceDataSource[service.key as keyof typeof serviceDataSource] ||
    serviceDataSource.nail;
...
export default function Service({ isActive = true }: { isActive?: boolean }) {
  ...
  const listServices: ServiceItem[] = [
    ...
    {
      key: "hair_removal",
      images: CarouselServiceHairRemoval,
      title: "Triệt lông",
